...
"""
A fairly old multimatch version, sufficient to compute the scanpath comparisons
for the studyforrest data.
The script combines functions of the pure multimatch algorithm and study-forrest
specific functions to extract the scanpaths.
Note: There is no simplification.
"""
